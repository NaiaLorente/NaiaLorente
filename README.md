...
| [**ai-data-analyst**]([https://github.com/NaiaLorente/ai-data-analyst](https://github.com/NaiaLorente/data-analyst)) | Natural-language data analysis agent | LangChain · LLMs · DuckDB |
...
| **CNN & Adversarial Robustness** | CIFAR-10 classifier with FGSM adversarial attacks and adversarial training | PyTorch · Torchvision |
| **Time-Series Forecasting** | Bike-share demand with ARIMA, SARIMAX, and LSTM benchmarks | statsmodels · pmdarima · PyTorch |

---

## 🛠 Skills

**ML & AI** — supervised/unsupervised learning, deep learning, time-series, NLP, model evaluation, AI ethics & bias detection  
**MLOps** — Docker, FastAPI, GitHub Actions, Streamlit, Grafana  
**Big Data** — PySpark, Hadoop, Airflow, AWS EC2  
**Languages** — Python · SQL · R · Java  
**Tools** — PyTorch · scikit-learn · LangChain · DuckDB · ChromaDB · MongoDB · Neo4j  
...
Spanish (native) · English (C1) · French (B2) · Basque (B1)

---

📫 lorentenaia6@gmail.com · [LinkedIn](https://linkedin.com/in/naia-lorente-martínez) · Bilbao, Spain
